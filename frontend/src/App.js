      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="text-xs text-slate-500 space-y-1">
            ...
            <p>• Column C: Quantity (defaults to 1 if not provided)</p>
          ...
          <div className="text-xs text-slate-500 space-y-1 border-t pt-3 mt-3">
            ...
            <p>• SL No, Item, Quantity</p>
            <p>• Min Rate, Medium Rate, Max Rate (per unit)</p>
            <p>• Min Total, Medium Total, Max Total (Rate × Qty)</p>
            ...
            <div className="space-y-2 text-sm mb-4 border-t border-slate-100 dark:border-slate-700 pt-3">
              ...
              <div className="mt-3 p-2 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
                <p className="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-1">
                  ...
                  Contact details not available for online sellers
                </p>
                <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                  Check "Local Stores" tab for vendors with contact info
                </p>
              </div>
            </div>
